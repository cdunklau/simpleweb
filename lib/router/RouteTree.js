...
let RouteTreeNode = require('./RouteTreeNode.js');
 ...
 */
RouteTree.prototype.getNodePath = function(node) {
 ...
 */
RouteTree.prototype.addRoute = function(route) {
 ...
 */
RouteTree.prototype.resolvePath = function(pathComponentStack) {
  let node = this.root;
  let component;
 ...
 */
RouteTree.prototype.addRemainingPath = function(
